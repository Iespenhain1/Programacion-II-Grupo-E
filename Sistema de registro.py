...
def nuevoPaciente():
    ...
    entryNombre.grid(row=0,column=1,padx=10,pady=5,sticky="ne")    
    #Direccion
    ...
    rbMasculino.grid(row=3,column=1,padx=10,pady=5,sticky="n",)
    rbMasculino.configure(bg="#A4A5D7")
    rbFemenino=tk.Radiobutton(ventanaRegistro, text="Femenino",variable=sexo,value="Femenino")
    rbFemenino.grid(row=4,column=1,padx=10,pady=5,sticky="n")
    rbFemenino.configure(bg="#A4A5D7")
